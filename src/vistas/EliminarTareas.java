...
public class EliminarTareas extends javax.swing.JFrame {
    ...
    private Boolean seElimino = false;
    ...
    private void eliminarTarea() {
        ...
        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "Seleccione una tarea para eliminar", "Error", JOptionPane.ERROR_MESSAGE);
            seElimino = false;
            return;
        }
        ...
        if (gt.eliminar(fila)) {
            ...
            JOptionPane.showMessageDialog(null, "Error al eliminar la tarea", "Error", JOptionPane.ERROR_MESSAGE);
            seElimino = false;
        }
    ...
    private void initComponents() {
        ...
        btn_seleccionar.setBackground(new java.awt.Color(204, 204, 204));
        btn_seleccionar.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        btn_seleccionar.setText("Selccionar");
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(btn_seleccionar, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(1, 1, 1)))
